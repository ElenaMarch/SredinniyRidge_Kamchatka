...
L.Control.GroupedLayers = L.Control.extend({
    ...
    onAdd: function(a) {
        return this._initLayout(), this._update(), a.on("layeradd", this._onLayerChange, this).on("layerremove", this._onLayerChange, this).on("zoomend", this._checkDisabledLayers, this), this._container
    },
    onRemove: function(a) {
    ...
    _checkDisabledLayers: function() {
        // console.log(this._form.getElementsByTagName("input"));
        for (var t, i, e = this._form.getElementsByTagName("input"), n = this._map.getZoom(), o = e.length - 1; 0 <= o; o--) t = e[o], i = this._getLayer(t.layerId).layer, t.disabled = void 0 !== i.options.minZoom && n < i.options.minZoom || void 0 !== i.options.maxZoom && n > i.options.maxZoom;
    },
}), 
