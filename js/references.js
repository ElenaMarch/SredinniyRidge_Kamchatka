...
var sidebar = L.control.sidebar('sidebar', {position: 'right'}),
	content = '<h2 style="margin-bottom:-6px">References</h2>\
			   ...
			   <p class="lorem">Markhinin E., Sirin A. et al.&nbsp;&nbsp 1962<br><a href="http://repo.kscnet.ru/3663/1/Marchinin_EK_BVS-32_1962.pdf" target="_blank">Experience of volcano-geographical zoning of Kamchatka and the Kuril Islands.</a> Bulletin of the Kamchatka Volcanological Station. vol 32. p. 52-70.</p>\
			   \
			   <h4 style="margin-bottom:-6px">Sredinniy ridge: quaternary and holocene volcanoes</h4>\
			   <p class="lorem">Ogorodov N., Kozhemyaka N.&nbsp;&nbsp 1972<br>Volcanoes and quaternary volcanism of the Sredinniy ridge of Kamchatka. ed. by Erlikh E., Moscow: Science — 191 p. (in Russian)\
			   \
			   ...
			   <p class="lorem">Vinogradov V.&nbsp;&nbsp 1968<br>The USSR glacier catalog. Kamchatka, vol. 20, part 2-4. Leningrad:Hydrometeorological service — 80 p. \
			   \
			   <br><hr><h2>Credits</h2>\
